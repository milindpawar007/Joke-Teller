...
//passibg Joke to VoiceRSS API
function tellMe(joke){
    VoiceRSS.speech({
        key: 'f0ee78f77dc74802b750b2939bde3be6',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJokes(){
    const urlApi= 'https://v2.jokeapi.dev/joke/Programming?blacklistFlags=religious,racist,sexist';
    let joke='';
    try {
